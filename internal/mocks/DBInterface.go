...
// UpdateUserNickname provides a mock function with given fields: ctx, uid, nickname
func (_m *DBInterface) UpdateUserNickname(ctx context.Context, uid int64, nickname string) error {
	ret := _m.Called(ctx, uid, nickname)
...
//   - uid int64
//   - nickname string
func (_e *DBInterface_Expecter) UpdateUserNickname(ctx interface{}, uid interface{}, nickname interface{}) *DBInterface_UpdateUserNickname_Call {
	return &DBInterface_UpdateUserNickname_Call{Call: _e.mock.On("UpdateUserNickname", ctx, uid, nickname)}
}

func (_c *DBInterface_UpdateUserNickname_Call) Run(run func(ctx context.Context, uid int64, nickname string)) *DBInterface_UpdateUserNickname_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *DBInterface_UpdateUserNickname_Call) RunAndReturn(run func(context.Context, int64, string) error) *DBInterface_UpdateUserNickname_Call {
	_c.Call.Return(run)
	return _c
}
